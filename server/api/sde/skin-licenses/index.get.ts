...
/**
 * @openapi
 * /api/sde/skin-licenses:
 *   get:
 *     summary: Get skin-licenses
 *     description: Returns a paginated list of skin-licenses from the Static Data Export.
 *     tags:
 *       - SDE - Cosmetics
 *     parameters:
 *       - name: page
 ...
 *     responses:
 *       '200':
 *         description: List of skin-licenses
 *         content:
 *           application/json:
 *             schema:
 *               type: object
