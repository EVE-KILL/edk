...
/**
 * @openapi
 * /api/constellations/{id}/killmails:
 *   get:
 *     summary: Get killmails for a constellation
 *     description: Returns a paginated list of killmails that occurred in this constellation.
 *     tags:
 *       - Constellations
 *     parameters:
 *       - name: id
