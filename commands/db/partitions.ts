...
async function action() {
  try {
    ...
    logger.info('This will create partitions from December 2007 through current + 3 months')
    logger.info('')
...
export default () => ({
  description: 'Creates missing partitions for killmails, attackers, and items tables from Dec 2007 to current + 3 months',
  action
})