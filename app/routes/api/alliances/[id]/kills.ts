 ...
 *
 * Returns alliance kills with pagination
 *
 * Query parameters:
...
export class Controller extends ApiController {
  ...
  override async handle(): Promise<Response> {
    ...
    try {
      ...
      console.error(`Error fetching kills for alliance ${allianceId}:`, error);
      return this.error("Failed to fetch alliance kills", 500);
    }
  }
}
