 ...
 *
 * Returns character losses with pagination
 *
 * Query parameters:
...
export class Controller extends ApiController {
  ...
  override async handle(): Promise<Response> {
    ...
    try {
      ...
      console.error(`Error fetching losses for character ${characterId}:`, error);
      return this.error("Failed to fetch character losses", 500);
    }
  }
}
